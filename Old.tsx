  ...
  useLayoutEffect(() => {
    ...
    function onTemplateHit(ev) {
      ...
      >
        ...
        preConfirm: async () => {
          const feeling = document.getElementById('textAreaFeeling').value;
          if (!feeling) {
            ...
            await html2canvas(document.getElementById('feel-card'), {
              ...
              imgLink = `${window.location}${canvas.toDataURL()}`;
        ...
        if (result.isConfirmed) {
          Swal.fire({
            ...
            <a class="link-secondary m-3" href="https://www.facebook.com/sharer.php?u=${imgLink}">
              <i class="fa-brands fa-facebook fa-2xl"></i>
            </a>
            <a class="link-secondary m-3" href="https://twitter.com/intent/tweet?url=${imgLink}">
              <i class="fa-brands fa-twitter fa-2xl"></i>
            </a>
            <a class="link-secondary m-3" href="https://web.whatsapp.com/send?text=${imgLink}">
              <i class="fa-brands fa-whatsapp fa-2xl"></i>
            </a>
            <a class="link-secondary m-3" href="#">
